...
;; - Don't use `defn` in a scope that isn't in the top-level. This is bad style, because you're affecting the top-level even though it's happening within a local scope.
